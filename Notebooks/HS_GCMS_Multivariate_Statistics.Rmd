...
# Removal of the T. angustula group from the dataset
permanova_fa_fu <- pqn_noqc[, pqn_noqc$Species != "T. angustula"]
pData(permanova_fa_fu) <- droplevels(pData(permanova_fa_fu))
# Change to factor varibles
permanova_fa_fu@phenoData@data$Group <- as.factor(permanova_fa_fu@phenoData@data$Group)

permanova_fa_fu <- permanova_fa_fu[, permanova_fa_fu$Site != "9"]
pData(permanova_fa_fu) <- droplevels(pData(permanova_fa_fu))



perform_permanova(permanova_fa_fu, group = "Species", nperm = 999)
...
write_to_excel(glog_no_qc, file = paste0(ppath, "../Result/notame_Result/HS_GCMS/glog_no_qc.xlsx"))
