...
data <- read_from_excel(file = "Data/Data_to_notame/HS_GCMS_Data_to_notame.xlsx", sheet = 2, 
                        corner_row = 5, corner_column = "L", 
...
multi.hist(s_aureus, global = FALSE)

#perform shapiro-wilk test
shapiro.test(s_aureus$`25_%_v_v`)

#perform shapiro-wilk test
shapiro.test(s_aureus$`50_%_v_v`)

#perform shapiro-wilk test
shapiro.test(s_aureus$`75_%_v_v`)

#perform shapiro-wilk test
shapiro.test(s_aureus$`100_%_v_v`)
...
k_pneumonia <- k_pneumonia[,-1]

multi.hist(k_pneumonia, global = FALSE)

#perform shapiro-wilk test
shapiro.test(k_pneumonia$`75_%_v_v`)
...
p_mirabilis <- p_mirabilis[,-1]

multi.hist(p_mirabilis, global = FALSE)

#perform shapiro-wilk test
shapiro.test(p_mirabilis$`50_%_v_v`)

#perform shapiro-wilk test
shapiro.test(p_mirabilis$`75_%_v_v`)

#perform shapiro-wilk test
shapiro.test(p_mirabilis$`100_%_v_v`)
