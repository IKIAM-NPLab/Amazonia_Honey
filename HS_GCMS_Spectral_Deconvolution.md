...
The spectral deconvolution method uses multivariate techniques based on blind source separation (BSS), alignment of spectra between samples, quantification and automated identification of metabolites by comparison with spectral libraries. (Domingo-Almenara et al., 2016)
...
```
### References
1. HS_GCMS_Spectral_Deconvolution
================
Angiely Camacho, José Abata, Jefferson Pastuna
2024-04-12
...
```
### References
1. Souza, E. C. A., Menezes, C., & Flach, A. (2021). Stingless bee honey (Hymenoptera, Apidae, Meliponini): a review of quality control, chemical profile, and biological potential. Apidologie, 52(1), 113-132. https://doi.org/10.1007/s13592-020-00802-0 
